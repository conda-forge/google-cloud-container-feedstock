About google-cloud-container-feedstock
======================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/google-cloud-container-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/google-cloud-container-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add google-cloud-container
# for installing globally
pixi global install google-cloud-container
```
...
It is possible to list all of the versions of `google-cloud-container` available on your platform:
...
```
pixi search google-cloud-container --channel conda-forge
```
