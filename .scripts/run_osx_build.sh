...
validate_recipe_outputs "google-cloud-container-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="google-cloud-container-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi